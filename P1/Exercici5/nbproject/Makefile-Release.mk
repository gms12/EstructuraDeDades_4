...
${OBJECTDIR}/_ext/4b80b819/circle.o: ../Exercici4/circle.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4b80b819/circle.o ../Exercici4/circle.cpp

${OBJECTDIR}/_ext/4b80b819/ellipse.o: ../Exercici4/ellipse.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/4b80b819
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4b80b819/ellipse.o ../Exercici4/ellipse.cpp
